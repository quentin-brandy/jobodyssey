...
import { ChangeExperience } from "../../libs/post";
export default function UpdateExperience({open , handleGetExperience , experience }) {
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        e.preventDefault();
        let response = await ChangeExperience(formData);
        if(response.message === "Experience modify successfully"){
